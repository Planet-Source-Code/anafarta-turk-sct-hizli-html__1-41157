...
Begin VB.Form frmliste 
   ...
   Begin VB.Label Label2 
      BackStyle       =   0  'Transparent
      Caption         =   "Liste öğelerinin sayısını seçiniz"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   162
...
Dim x As Long, y
    ' NOKTA (BULLET) LİSTESİ
    If optbullet.Value = True Then
    frmAna.textHTML.SelRTF = "<UL>" + vbCrLf
        Do
            x = txtlist.Text
            frmAna.textHTML.SelRTF = "<LI> Öğelerinizi burada listeleyin </LI>"
            y = y + 1
        Loop While y < x
    frmAna.textHTML.SelRTF = "</UL>" + vbCrLf
    End If
    ' ALFABETİK SIRAYLA HARF LİSTESİ
